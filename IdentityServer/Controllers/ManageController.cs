...
using IdentityServer.ViewModels.Manage;
...
namespace IdentityServer.Controllers
{
         ...
         where TKey : IEquatable<TKey>
    {
        ...
        public ManageController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IEmailSender emailSender, ILogger<ManageController<TUser, TKey>> logger, IGenericControllerLocalizer<ManageController<TUser, TKey>> localizer, UrlEncoder urlEncoder)
        {
        ...
        public async Task<IActionResult> Index(ApplicationUser model)
        {
            ...
            if (result.Succeeded)
                ViewData["StatusMessage"] = _localizer["ProfileUpdated"].Value;
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("CheeseCake.IdentityServer4"),
